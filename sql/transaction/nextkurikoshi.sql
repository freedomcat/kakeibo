...
UPDATE Kakeibo SET NextKurikoshi = 0-(SELECT SUM(HK.Amount) FROM (SELECT * FROM Kurikoshi AS P WHERE P.mid=12 UNION SELECT * FROM HimokuGroupTotal AS H WHERE H.mid=12) AS HK);
